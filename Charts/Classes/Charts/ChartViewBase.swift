...
open class ChartViewBase: UIView, ChartAnimatorDelegate
{
    ...
    open func setExtraOffsets(_ left: CGFloat, top: CGFloat, right: CGFloat, bottom: CGFloat)
    {
    ...
    internal func calculateFormatter(_ min: Double, max: Double)
    {
    ...
    internal func drawDescription(_ context: CGContext?)
    {
    ...
    open func highlightValue(_ xIndex: Int, dataSetIndex: Int, callDelegate: Bool)
    {
    ...
    open func highlightValue(_ highlight: ChartHighlight?, callDelegate: Bool)
    {
    ...
    internal func drawMarkers(_ context: CGContext?)
    {
    ...
    open func getMarkerPosition(_ entry: ChartDataEntry, highlight: ChartHighlight) -> CGPoint
    {
    ...
    open func getChartImage(_ transparent: Bool) -> UIImage
    {
